...
export interface ClanTreeNode extends ClanMemberInput { id:string; memberId:string; name:string; title?:string; role:ClanRole; displayOrder:number; active:boolean; level:number; levelName:string; xp:number; }
