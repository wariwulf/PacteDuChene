...
def load_settings() -> Settings:
    ...
    order_poll_raw = os.getenv("ORDER_POLL_SECONDS", "5").strip()
    ...
    try:
        ...
        order_poll_seconds = int(order_poll_raw)
    ...
    if order_poll_seconds < 5:
        raise RuntimeError("ORDER_POLL_SECONDS doit être supérieur ou égal à 5 secondes.")
