...
from services.orders import DiscordOrderService
...
class PacteBot(commands.Bot):
    def __init__(self, settings: Settings) -> None:
        ...
        self.order_service = DiscordOrderService(self, self.api_client, settings.discord_guild_id, settings.pacte_site_url, settings.order_poll_seconds)
